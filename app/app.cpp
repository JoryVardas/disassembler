...
int main(/*int argc, char* argv[]*/) {
    try {
        ...
        std::vector<std::byte> test = {std::byte(0x80),
                                       std::byte(0xd1),
                                       std::byte(0x02),
                                       std::byte(0x81),
                                       std::byte(0xd1),
                                       ...
                                       std::byte(0xd5),
                                       std::byte(0x0a),
                                       std::byte(X86InstructionRawPrefix::LOCK),
                                       std::byte(0x37)};

        BidirectionalIterator<std::byte> byteStream(
            std::data(test), static_cast<const int64_t>(std::size(test)));

        X86Environment env;
        env._defaultAdressMode = X86Environment::X86AddressMode::X32;
        env._defaultInstructionMode =
