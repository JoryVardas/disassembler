...
typedef std::vector<X86InstructionRegisterParameter> X86InstructionRegisterParameterGroup;

#define REGISTER(name) X86InstructionRegisterParameterList.at(#name)

const std::vector<X86InstructionRegisterParameterGroup> X86InstructionRegisterParameterGroups 
{
    {
        REGISTER(AL),
        REGISTER(AX),
...
const std::vector<X86InstructionRegisterParameter> X86SibDisplacementRegisterList{
    X86InstructionRegisterParameterList.at("EAX"),
    X86InstructionRegisterParameterList.at("ECX"),
    X86InstructionRegisterParameterList.at("EDX"),
    X86InstructionRegisterParameterList.at("EBX"),
