...
#define PREFIX_LIST(...)                                                       \
    std::vector<X86InstructionPrefix> { __VA_ARGS__ }
...
const std::vector<X86InstructionPrototype> X86InstructionPrototypeList{
    ...
    {"ADC",
     ...
     ANY_PREFIX,
     0x14,
     {PARAMETER(IMPLIED, AL), PARAMETER(IMMEDIATE, imm8)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x15,
     {PARAMETER(IMPLIED, AX, EAX, RAX), PARAMETER(IMMEDIATE, imm16, imm32)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x80,
     2,
     {PARAMETER(MODRM_RM, rm8), PARAMETER(IMMEDIATE, imm8)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x81,
     2,
     {PARAMETER(MODRM_RM, rm16, rm32, rm64),
      PARAMETER(IMMEDIATE, imm16, imm32)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x83,
     2,
     {PARAMETER(MODRM_RM, rm16, rm32, rm64), PARAMETER(IMMEDIATE, imm8)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x10,
     {PARAMETER(MODRM_RM, rm8), PARAMETER(MODRM_REG, r8)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x11,
     {PARAMETER(MODRM_RM, rm16, rm32, rm64),
      PARAMETER(MODRM_REG, r16, r32, r64)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
     0x12,
     {PARAMETER(MODRM_REG, r8), PARAMETER(MODRM_RM, rm8)},
     STANDARD_COMPARISON},
    {"ADC",
     MODE::BOTH,
     ANY_PREFIX,
    ...
    {"ADCX",
     MODE::BOTH,
     PREFIX_LIST(PREFIX_66),
     0x0f38f6,
     {PARAMETER(MODRM_REG, r32, r64), PARAMETER(MODRM_RM, rm32, rm64)},
     STANDARD_COMPARISON},
