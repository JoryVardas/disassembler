...
using X86InstructionParameterPrototype =
    variant_join<X86InstructionRegisterParameterPrototype_t,
                 X86InstructionAddressParameterPrototype_t,
                 X86InstructionImmediateParameterPrototype_t>;

auto x86InstructionParameterPrototypeSpecify =
    make_visitor(x86InstructionRegisterParameterPrototypeSpecify,
