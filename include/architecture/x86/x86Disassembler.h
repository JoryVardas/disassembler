...
class X86Disassembler : public Disassembler {
  public:
    ...
    std::unique_ptr<Instruction> decodeInstruction(
        BidirectionalIterator<std::byte>& bytesToDecode) const override;
  ...
  private:
    ...
    std::vector<X86InstructionPrefix> decodeInstructionPrefixes(
        BidirectionalIterator<std::byte>& bytesToDecode) const;
    X86InstructionOpcode retrieveInstructionOpcode(
        BidirectionalIterator<std::byte>& bytesToDecode) const;
    X86InstructionPrototype decodeInstructionPrototype(
