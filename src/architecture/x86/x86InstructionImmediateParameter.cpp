...
X86InstructionImmediateParameter::X86InstructionImmediateParameter(
    const X86InstructionImmediateParameter&) = default;
X86InstructionImmediateParameter::X86InstructionImmediateParameter(
    X86InstructionImmediateParameter&&) = default;
X86InstructionImmediateParameter::X86InstructionImmediateParameter(
...
X86InstructionImmediateParameter& X86InstructionImmediateParameter::operator=(
    const X86InstructionImmediateParameter&) = default;
X86InstructionImmediateParameter& X86InstructionImmediateParameter::operator=(
    X86InstructionImmediateParameter&&) = default;