...
const std::string X86InstructionAddressParameterSizeToString(
    const X86InstructionAddressParameterSize addressParameterSize) {
...
X86InstructionAddressParameter::X86InstructionAddressParameter(
    const X86InstructionAddressParameter&) = default;
X86InstructionAddressParameter::X86InstructionAddressParameter(
    X86InstructionAddressParameter&&) = default;
...
X86InstructionAddressParameter::X86InstructionAddressParameter(
    ...
    : _addressSize(addressSize), _registerBase(baseRegister),
      _scaleFactor(scaleFactor), _constantDisplacement(constantDisplacement) {}
X86InstructionAddressParameter::X86InstructionAddressParameter(
    const X86InstructionAddressParameterSize addressSize,
    const X86InstructionAddressDisplacement constantDisplacement)
...
X86InstructionAddressParameter::X86InstructionAddressParameter(
    ...
    const X86InstructionAddressDisplacement constantDisplacement)
    : _addressSize(addressSize), _registerBase(baseRegister),
      _constantDisplacement(constantDisplacement) {}
X86InstructionAddressParameter::X86InstructionAddressParameter(
    const X86InstructionAddressParameterSize addressSize,
    const X86InstructionRegisterParameter& baseRegister,
    ...
    const X86InstructionAddressDisplacement constantDisplacement)
    : _addressSize(addressSize), _registerBase(baseRegister),
      _registerDisplacement(registerDisplacement),
      _constantDisplacement(constantDisplacement) {}
X86InstructionAddressParameter::X86InstructionAddressParameter(
    const X86InstructionAddressParameterSize addressSize,
    const X86InstructionRegisterParameter& baseRegister,
    ...
    const X86InstructionAddressDisplacement constantDisplacement)
    : _addressSize(addressSize), _registerBase(baseRegister),
      _scaleFactor(scaleFactor), _registerDisplacement(registerDisplacement),
      _constantDisplacement(constantDisplacement) {}
...
std::string X86InstructionAddressParameter::toString() const {
    ...
    if (_registerDisplacement)
        returnString << _registerDisplacement.value().toString() << " + ";
    if (_registerBase)
        returnString << _registerBase.value().toString();
    if (_scaleFactor != 1)
        returnString << "*" << std::to_string(_scaleFactor);
    if (_constantDisplacement != 0)
        returnString << " + " << std::to_string(_constantDisplacement);

    returnString << "]";
    return returnString.str();
}

X86InstructionAddressParameter& X86InstructionAddressParameter::operator=(
    const X86InstructionAddressParameter&) = default;
X86InstructionAddressParameter& X86InstructionAddressParameter::operator=(
    X86InstructionAddressParameter&&) = default;